...
/// </summary>
[JsonConverter(typeof(PatchConverter<PatchGitHubAuthenticatorOptionsRequest>))]
public class PatchGitHubAuthenticatorOptionsRequest
{
  /// <summary>
  ...
  /// </summary>
  /// <note>When enabled, MonoCloud skips email verification if GitHub reports the email as verified.</note>
