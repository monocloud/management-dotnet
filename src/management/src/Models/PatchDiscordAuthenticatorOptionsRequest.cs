...
/// </summary>
[JsonConverter(typeof(PatchConverter<PatchDiscordAuthenticatorOptionsRequest>))]
public class PatchDiscordAuthenticatorOptionsRequest
{
  /// <summary>
  ...
  /// </summary>
  /// <note>When enabled, MonoCloud skips email verification if Discord reports the email as verified.</note>
