...
/// </summary>
[JsonConverter(typeof(PatchConverter<PatchXeroAuthenticatorOptionsRequest>))]
public class PatchXeroAuthenticatorOptionsRequest
{
  /// <summary>
  ...
  /// </summary>
  /// <note>Xero does not provide an explicit email verification claim. When enabled, MonoCloud treats the email provided by Xero as verified and skips additional email verification.</note>
